export const DAKINIS_SYSTEM_PAGE_CONTENT = {
  ...
  peluqueria: {
    ...
    highlights: ["Agenda por silla y profesional", "Reserva online sin friccion", "Campanas de retorno automaticas"],
    ...
    workflow: [
      { title: "Agenda salon", items: ["09:00 Corte + peinado", "10:00 Coloracion premium", "11:30 Keratina"] },
      { title: "Reservas online", items: ["5 nuevas reservas web", "2 reprogramaciones", "1 cancelacion recuperada"] },
      { title: "Fidelizacion", items: ["12 clientes para promo retorno", "5 cumpleaños esta semana", "3 packs por sugerir"] }
    ],
    automations: [
    ...
    quickActions: ["Ver huecos de estilistas", "Publicar promo de baja ocupacion", "Enviar WhatsApp a clientes VIP"]
  },
  inmobiliaria: {
    ...
    highlights: ["Agenda de visitas por propiedad", "Embudo claro por etapa comercial", "Metricas de conversion por agente"],
    ...
    workflow: [
      ...
      { title: "Pipeline comercial", items: ["9 leads en contacto", "6 en propuesta", "3 en negociacion final"] },
      {
...
export const DAKINIS_SYSTEM_MOCKUPS = {
  clinica: {
    ...
    initialRecords: [
      { id: "local-c-1", nombre: "Elena Suarez", tratamiento: "Botox", fecha: "2026-05-02", estado: "Confirmado" },
      { id: "local-c-2", nombre: "Marta Ruiz", tratamiento: "Peeling", fecha: "2026-05-03", estado: "Pendiente" }
    ]
  },
  peluqueria: {
    entityLabel: "reserva",
    ...
    initialRecords: [
      { id: "local-p-1", cliente: "Raquel Martin", servicio: "Corte + peinado", estilista: "Diana", hora: "10:30" },
  ...
  inmobiliaria: {
    ...
    initialRecords: [
      { id: "local-i-1", nombre: "Carlos Diaz", propiedad: "Chalet zona norte", agente: "Mario", etapa: "Visita" },
      { id: "local-i-2", nombre: "Ana Torres", propiedad: "Oficina premium", agente: "Lucia", etapa: "Propuesta" }
    ]
  }
};
