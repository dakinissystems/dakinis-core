const logoGrande = new URL("../../Logo Grande.jpeg", import.meta.url).href;
    ...
    <>
      <section className="hero">
        <div className="container hero-grid">
          <div>
            ...
            <h1>
              Menos cancelaciones.<br />Mas clientes.<br />Mas control.
            </h1>
            <p className="lead">
              Cada negocio tiene su <strong>tenant</strong> persistido (<code>x-business-id</code>) mas login JWT opcional.
            </p>
          ...
          <div className="hero-card">
            ...
            <ul>
              <li>Datos por <code>x-business-id</code> en API</li>
      ...
      <section id="modulos" className="modules">
        <div className="container">
          ...
          <p className="lead">
            Slugs seed: clinica-demo, peluqueria-demo, inmobiliaria-demo. API key desarrollo:&nbsp;
            <code>dakinis-dev-key</code>
          </p>
          <div className="system-switcher">
            {Object.entries(dakinisSystemRegistry).map(([systemKey, systemInfo]) => (
              <button key={systemKey} type="button" className="system-btn" onClick={() => navigate(`/sistema/${encodeURIComponent(systemKey)}`)}>
                {systemInfo.label}
              </button>
            ))}
          </div>
