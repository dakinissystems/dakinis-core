export const dakinisSystemModulesCatalog = {
  clinica: {
    label: "Clínica estética",
    modules: [
      {
        title: "Agenda médica",
        features: ["Bloques por cabina", "Duración por tratamiento", "Control de no-show"]
      },
      {
        title: "CRM pacientes",
        features: ["Historial clínico comercial", "Segmento VIP", "Clientes inactivos 45 días"]
      },
      {
  ...
  peluqueria: {
    ...
    modules: [
      {
        title: "Agenda estilistas",
        features: ["Sillas y estilistas", "Duración por servicio", "Reagendado rápido"]
      },
      {
        title: "Reserva online",
        features: ["Link público", "Selección de profesional", "Servicios múltiples"]
      },
      {
        title: "Fidelización",
    ...
    modules: [
      {
        ...
        features: ["Visitas por propiedad", "Calendario por agente", "Reprogramación guiada"]
      },
      {
        title: "Embudo comercial",
        features: ["Lead > contacto > visita", "Propuesta y cierre", "Gestión de perdidos"]
      },
      {
