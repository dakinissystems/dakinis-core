...
export default {
  ...
  restaurant: {
    ...
    waiterLead: "Floor plan, table orders and payment. Drag tables to rearrange the room.",
    ...
    floorDragHint:
      "Press and drag each table; release to save its position (like the StreamAutomator store layout).",
    ...
    mesaSelectHint: "Select a table on the floor plan.",
  ...
  app: {
    ...
    crm: {
      ...
      journeyHint: "Next: contacts, companies and deals stored in the database.",
