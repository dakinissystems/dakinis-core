...
export default {
  ...
  kitchen: {
    ...
    loadErrorAlertHint: "A critical alert was created under Suppliers for this load failure.",
    retry: "Retry",
    ...
    scanSearching: "Looking for barcode…",
    scanSearchingActive: "Detecting… keep the code inside the frame",
    scanConfirmed: "Code confirmed",
    scanStabilizing: "Looking for barcode…",
    scanCodeCol: "Code",
    ...
    scanProductExpiry: "Expiry date (optional)",
  ...
  restaurant: {
    ...
    businessKpis: [
      ...
      { label: "Tables busy", value: "12/18" },
      { label: "Kitchen tickets", value: "7" }
    ],
    roleNav: "Restaurant view",
    roleWaiter: "Waiters",
    roleKitchen: "Kitchen",
    roleAdmin: "Administration",
    taskNav: "Restaurant modules",
    taskSala: "Floor",
    taskCocina: "Kitchen",
    taskInventario: "Inventory",
    taskDelivery: "Delivery",
    taskCaja: "Cash",
    taskConfig: "Config",
    opsOpen: "Open",
    opsClosed: "Closed",
    opsBreadcrumb: "Location",
    opsShowCommercial: "Show pitch",
    opsBackToWork: "Back to operations",
    opsStatuses: "System status",
    opsQuickActions: "Contextual actions",
    opsStatOrders: "Orders",
    opsStatAlerts: "Alerts",
    opsStatCash: "Cash",
    opsQuickKitchen: "Go to kitchen",
    opsQuickStock: "Fix stock",
    opsQuickDelivery: "Open delivery",
    invSubnav: "Inventory",
    invGroupOps: "Operations",
    invGroupMgmt: "Management",
    invTabScan: "Scan",
    invTabStock: "Stock",
    invTabLots: "Lots",
    invTabProduction: "Production",
    invTabRecipes: "Recipes",
    invTabAlerts: "Alerts",
    invAlertsEmpty: "No merchandise alerts configured.",
    configSubnav: "Settings",
    configPlano: "Floor",
    configCarta: "Menu",
    configCompras: "Purchasing",
    configSeguridad: "Safety",
    configIntegraciones: "Integrations",
    configIntegracionesLead: "External channels live in Delivery (orders first).",
    configOpenDelivery: "Open Delivery",
    cajaTpvTitle: "Register (today)",
    cajaTpvOrders: "Payments",
    cajaTpvCash: "Total",
    cajaTpvClose: "Go to close-out",
    cajaOpeningLabel: "Start of day",
    cajaOpeningInput: "Opening cash (€)",
    cajaOpeningSave: "Save float",
    cajaOpeningSaved: "Opening cash saved",
    cajaOpeningError: "Could not save opening cash",
    cajaOpeningHint: "Expected cash = opening float + cash payments today.",
    cajaExpectedCash: "Expected cash",
    cajaCashSales: "Cash payments",
    deliveryViewOps: "Operations",
    deliveryViewConfig: "Settings",
    deliveryOrdersTitle: "Active orders",
    deliveryOrdersLead: "Volume by channel · incidents · timing.",
    deliveryHealth: "Channels",
    deliverySimulate: "Simulate Manual order",
    deliverySimulated: "Manual order simulated",
    deliveryPending: "Marketplace pending",
    deliveryJobs: "Queue / incidents",
    deliveryIntegrations: "Integrations",
    deliveryConfigLead: "Credentials, webhooks and rates. Staff operate in the Operations tab.",
    deliveryEnabled: "Enabled",
    priceListsTitle: "Channel price lists",
    priceListsLead: "Dine-in / takeaway / Glovo… can use different markups.",
    priceListName: "Price list",
    cmdkOpenTable: "Open table",
    cmdkOpenDelivery: "Open Delivery",
    cmdkOpenStock: "Open inventory / scanner",
    cmdkOpenCaja: "Open cash / invoices",
    cmdkOpenMenu: "Edit menu / prices",
    cmdkOpenKitchen: "Open kitchen",
    waiterLead:
      "Tap a table to load the order (kitchen and payment).",
    ...
    adminPricesLead: "Edit each product price and click Save prices.",
    adminPricesEmpty: "No dishes in business configuration. Add the first one below.",
    adminPricesSave: "Save prices",
    adminPricesSaved: "Prices updated.",
    adminProductAddTitle: "Add product manually",
    adminProductAddLead: "Add a new dish or product to the menu with its price.",
    adminProductName: "Name",
    adminProductNamePlaceholder: "e.g. Vanilla ice cream",
    adminProductNameRequired: "Enter the product name.",
    adminProductCategory: "Category",
    adminProductCategoryPlaceholder: "e.g. Ice cream, Sandwiches…",
    adminProductCategoryDefault: "Other",
    adminProductDescription: "Description (optional)",
    adminProductDescriptionPlaceholder: "Ingredients or short notes",
    adminProductPriceRequired: "Enter a valid price (≥ 0).",
    adminProductAddSave: "Add to menu",
    adminProductAdded: "Product “{name}” added to the menu.",
    adminProductAddError: "Could not add the product",
    priceEur: "Price (€)",
    saving: "Saving…",
  ...
  app: {
    ...
    whatsapp: {
      ...
      aiLead: "Copilot with WhatsApp thread context and business signals.",
      aiThreadLabel: "Conversation (optional)",
      aiNoThread: "No thread — business context only",
      aiPlaceholder: "Ask about a thread, draft a reply, or request a summary…",
      aiAsk: "Ask Copilot",
      aiAsking: "Consulting AI…",
      aiAnswerTitle: "Suggestion",
      aiDegradedHint: "Rule-based answer — configure OpenAI on dakinis-ai for full AI.",
      aiContextHint: "Context: last {count} messages from the selected thread.",
      aiItems: [
    ...
    settings: {
      ...
      allergensConfig: "Edit allergens",
