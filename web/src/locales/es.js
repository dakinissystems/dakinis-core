...
export default {
  ...
  inventoryLots: {
    ...
    expiry: "Vencimiento",
    expiryOptional: "Vencimiento (opcional)",
    quantity: "Cantidad",
    location: "Ubicación",
    supplier: "Proveedor",
  ...
  kitchen: {
    ...
    loadErrorAlertHint: "Se ha generado una alerta crítica en Proveedores para este fallo de carga.",
    retry: "Reintentar",
    ...
    scanSearching: "Buscando código…",
    scanSearchingActive: "Detectando… mantén el código en el recuadro",
    scanConfirmed: "Código confirmado",
    scanStabilizing: "Buscando código…",
    scanCodeCol: "Código",
    ...
    scanProductExpiry: "Fecha de vencimiento (opcional)",
  ...
  restaurant: {
    ...
    roleKitchen: "👨‍🍳 Cocina",
    roleAdmin: "⚙️ Gestión",
    taskNav: "Módulos del restaurante",
    taskSala: "Sala",
    taskCocina: "Cocina",
    taskInventario: "Inventario",
    taskDelivery: "Delivery",
    taskCaja: "Caja",
    taskConfig: "Config",
    opsOpen: "Abierto",
    opsClosed: "Cerrado",
    opsBreadcrumb: "Ubicación",
    opsShowCommercial: "Ver presentación",
    opsBackToWork: "Volver a operación",
    opsStatuses: "Estado de sistemas",
    opsQuickActions: "Acciones contextuales",
    opsStatOrders: "Comandas",
    opsStatAlerts: "Alertas",
    opsStatCash: "Caja",
    opsQuickKitchen: "Ir a cocina",
    opsQuickStock: "Resolver stock",
    opsQuickDelivery: "Ver delivery",
    invSubnav: "Inventario",
    invGroupOps: "Operación",
    invGroupMgmt: "Gestión",
    invTabScan: "Escanear",
    invTabStock: "Stock",
    invTabLots: "Lotes",
    invTabProduction: "Producción",
    invTabRecipes: "Recetas",
    invTabAlerts: "Alertas",
    invAlertsEmpty: "Sin alertas de mercancía configuradas.",
    configSubnav: "Configuración",
    configPlano: "Plano",
    configCarta: "Carta",
    configCompras: "Compras",
    configSeguridad: "Seguridad",
    configIntegraciones: "Integraciones",
    configIntegracionesLead: "Canales externos y partners viven en Delivery (pedidos primero).",
    configOpenDelivery: "Abrir Delivery",
    cajaTpvTitle: "Caja (hoy)",
    cajaTpvOrders: "Cobros",
    cajaTpvCash: "Total",
    cajaTpvClose: "Ir a cierre",
    cajaOpeningLabel: "Inicio de día",
    cajaOpeningInput: "Dinero inicio de día (€)",
    cajaOpeningSave: "Guardar fondo",
    cajaOpeningSaved: "Fondo de caja guardado",
    cajaOpeningError: "No se pudo guardar el fondo",
    cajaOpeningHint: "Efectivo esperado = inicio + cobros en efectivo del día.",
    cajaExpectedCash: "Efectivo esperado",
    cajaCashSales: "Cobros en efectivo",
    deliveryViewOps: "Operación",
    deliveryViewConfig: "Configuración",
    deliveryOrdersTitle: "Pedidos activos",
    deliveryOrdersLead: "Volumen por canal · incidencias · tiempo.",
    deliveryHealth: "Canales",
    deliverySimulate: "Simular pedido Manual",
    deliverySimulated: "Pedido manual simulado",
    deliveryPending: "Pendientes marketplace",
    deliveryJobs: "Cola / incidencias",
    deliveryIntegrations: "Integraciones",
    deliveryConfigLead: "Credenciales, webhooks y tarifas. El encargado opera en la pestaña Operación.",
    deliveryEnabled: "Activo",
    priceListsTitle: "Tarifas por canal",
    priceListsLead: "Sala / takeaway / Glovo… pueden tener markup distinto.",
    priceListName: "Tarifa",
    cmdkOpenTable: "Abrir mesa",
    cmdkOpenDelivery: "Abrir Delivery",
    cmdkOpenStock: "Abrir inventario / escáner",
    cmdkOpenCaja: "Abrir caja / facturas",
    cmdkOpenMenu: "Editar carta / precios",
    cmdkOpenKitchen: "Abrir cocina",
    waiterLead:
      "Toca una mesa para cargar el pedido (cocina y cobro).",
    ...
    adminPricesLead: "Edita el precio de cada producto y pulsa Guardar precios.",
    adminPricesEmpty: "Sin platos en la configuración del negocio. Añade el primero abajo.",
    adminPricesSave: "Guardar precios",
    adminPricesSaved: "Precios actualizados.",
    adminProductAddTitle: "Cargar producto a mano",
    adminProductAddLead: "Añade un plato o producto nuevo a la carta con su precio.",
    adminProductName: "Nombre",
    adminProductNamePlaceholder: "Ej. Helado de vainilla",
    adminProductNameRequired: "Indica el nombre del producto.",
    adminProductCategory: "Categoría",
    adminProductCategoryPlaceholder: "Ej. Helados, Montaditos…",
    adminProductCategoryDefault: "Otros",
    adminProductDescription: "Descripción (opcional)",
    adminProductDescriptionPlaceholder: "Ingredientes o notas cortas",
    adminProductPriceRequired: "Indica un precio válido (≥ 0).",
    adminProductAddSave: "Añadir a la carta",
    adminProductAdded: "Producto «{name}» añadido a la carta.",
    adminProductAddError: "No se pudo añadir el producto",
    priceEur: "Precio (€)",
    saving: "Guardando…",
  ...
  app: {
    ...
    whatsapp: {
      ...
      aiLead: "Copilot con contexto de conversaciones WhatsApp y señales del negocio.",
      aiThreadLabel: "Conversación (opcional)",
      aiNoThread: "Sin hilo — solo contexto del negocio",
      aiPlaceholder: "Pregunta sobre un hilo, redacta una respuesta o pide un resumen…",
      aiAsk: "Preguntar a Copilot",
      aiAsking: "Consultando IA…",
      aiAnswerTitle: "Sugerencia",
      aiDegradedHint: "Respuesta por reglas — configura OpenAI en dakinis-ai para IA completa.",
      aiContextHint: "Contexto: últimos {count} mensajes del hilo seleccionado.",
      aiItems: [
    ...
    settings: {
      ...
      allergensConfig: "Editar alérgenos",
